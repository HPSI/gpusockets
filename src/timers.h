...
#ifndef __gpusock_timers_h__
#define __gpusock_timers_h__
...
{
        struct timeval tv;
	unsigned long long paparia;
        gettimeofday(&tv,NULL);
        paparia = tv.tv_sec * 1000000 + tv.tv_usec;
	printf("paparia:%ld\n", paparia);
	return paparia;
}
...
#define var_name(x) #x
#define gpusock_timer_reset(x) TIMER_RESET(x);
#endif	/* __gpusock_timers_h__ */
